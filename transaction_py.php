...
::-webkit-scrollbar-thumb {
    ...
    <!--Class-->
    <h1 class="text-dark text-center" id="Course" data-aos="zoom-in" data-aos-delay="200">Course</h1>
        ...
        <div class="card-group vgr-cards">
            ...
            <div class="card">
                <div class="card-img-body">
                    <img class="card-img" src="assets/img/transaction_py/2.jpg" alt="Card image cap">
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-img-body">
                    <img class="card-img" src="assets/img/transaction_py/3.jpg" alt="Card image cap">
                </div>
                <div class="card-body">
                    ...
                    <hr style="color: gray;">
                    <p class="card-text text-center">choose what library you want to learn and can ask if there is a
                        problem that makes you confused with the tutor teacher</p>
                    <hr style="color: gray;">
