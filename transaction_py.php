  ...
  <div class="card-group vgr-cards">
    ...
    <div class="card">
      <div class="card-img-body">
        <img class="card-img" src="assets/img/transaction_js/2(no_bg).png" alt="Card image cap"></div>
      <div class="card-body">
    ...
    <div class="card">
      <div class="card-img-body">
        <img class="card-img" src="assets/img/transaction_js/3(no_bg).png" alt="Card image cap"></div>
      <div class="card-body">
