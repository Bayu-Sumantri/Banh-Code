    ...
    <section class="projects-section bg-light" id="projects">
        <div class="container px-4 px-lg-5">
            ...
            <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
                <div class="col-xl-8 col-lg-7"><img class="img-fluid mb-3 mb-lg-0" src="assets/img/icikiwir.jpg" alt="..." /></div>
                    ...
                    <div class="text-center h-100 project" style="background-color: #C4C8E3;">
                        <div class="d-flex h-100">
                            <div class="project-text w-100 my-auto text-center text-lg-left">
                                ...
                                <p class="mb-0 text-black-80">We provide program classes which include javascript, php and python, we will provide tips and tricks to make this programming faster.</p>
